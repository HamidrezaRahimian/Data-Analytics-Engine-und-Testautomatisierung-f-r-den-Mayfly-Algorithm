...
On Java 25, Gradle/JGiven/Jacoco dependencies may print runtime warnings about `sun.misc.Unsafe`, native access, or missing SLF4J providers. These warnings come from the allowed build and report tooling during test/report execution; the project sources compile without preview features and without project compiler warnings.
